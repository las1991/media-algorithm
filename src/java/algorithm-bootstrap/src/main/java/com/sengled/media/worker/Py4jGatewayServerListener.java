...
public class Py4jGatewayServerListener extends DefaultGatewayServerListener{
    ...
    public void connectionError(Exception e) {
        LOGGER.error("connectionError python port:" + gatewayServer.getPythonPort());
        tryShutdown();
    }

    @Override
    public void connectionStopped(Py4JServerConnection gatewayConnection) {
        LOGGER.error("connectionStopped python port:" + gatewayServer.getPythonPort());
        tryShutdown();
    }

    @Override
    public void serverError(Exception e) {
        LOGGER.error("serverError python port:" + gatewayServer.getPythonPort());
        tryShutdown();
    }

    @Override
    public void serverPostShutdown() {
        LOGGER.error("serverPostShutdown python port:" + gatewayServer.getPythonPort());
        tryShutdown();
    }

    @Override
    public void serverStopped() {
        LOGGER.error("serverStopped python port:" + gatewayServer.getPythonPort());
        tryShutdown();
    }
