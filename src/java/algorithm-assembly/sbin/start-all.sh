...
export JMEDIA_OPTS=" -Dserver.name=media-algorithm-v3 -Dcom.amazonaws.sdk.disableCbor -Dspring.config.location=${CONFIGS}file:/etc/sengled/sengled.properties"
export JMEDIA_OPTS=" -Djni.library.path=$SENGLED_APP_HOME/libc -Djna.library.path=$SENGLED_APP_HOME/libc $JMEDIA_OPTS"
export JMEDIA_OPTS=" -Dkinesis.checkpoint.delete=${KINESIS_CHECKPOINT_ALL_DELETE} $JMEDIA_OPTS"
