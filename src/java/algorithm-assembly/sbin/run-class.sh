...
JMEDIA_OPTS=$JMEDIA_OPTS" -Dio.netty.allocator.type=pooled -Dio.netty.noPreferDirect=true -Dio.netty.leakDetection.level=SIMPLE -Dio.netty.leakDetection.maxRecords=128"
